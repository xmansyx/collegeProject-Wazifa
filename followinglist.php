            ...
            <div class="col-xs-12">
              <div class="box box-solid">
                    ...
                    <div class="col-md-3 col-sm-4">
                      ...
                      <div style="margin-top: 15px;">
                        <ul class="nav nav-pills nav-stacked">
                          ...
                          <li class="active"><a href="#"><i class="fa fa-inbox"></i> following (<?php  include 'model/profile.php'; $profile = new profile();
                            if ($profile->showfollowinglist($_SESSION['id'])==0) {
                             echo "0";
                            }
                          else{ echo count($profile->showfollowinglist($_SESSION['id']));}?>)</a></li>
                ...
                <div class="table-responsive">
                     ...
                     // $profile = new profile();
                      $followinglist = $profile -> showfollowinglist($_SESSION['id']);
                      if ($profile -> showfollowinglist($_SESSION['id'])!=0) {
                         # code...
                        foreach ( $followinglist as $following) : ?>
                          <div class="div1">  
                            <ul>  
                                  <li>
                                      <img src="<?php echo $following['img'];?>" class="friend-image"> 
                                    <a href="<?php echo "profile.php?id=".$following['iduser'];?>"><?php echo $following['firstname']." ".$following['lastname'];?></a></li>
                              </ul>
                          </div>  
                        <?php 
                        endforeach;
                           ...
                           echo "you don't have any followings yet";
                         }
