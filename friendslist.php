                    ...
                    <div class="col-md-3 col-sm-4">
                      ...
                      <div style="margin-top: 15px;">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                          ...
                          <li class="active"><a href="#"><i class="fa fa-inbox"></i> friends (<?php  include 'model/Profile.php'; $profile = new profile(); echo count($profile->showfriendlist($_SESSION['id']))?>)</a></li>
...
<!-- mn awel hnaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
                ...
                <div class="table-responsive">
                     ...
                     // $profile = new profile();
                      $friendslist = $profile -> showfriendlist($_SESSION['id']);
                       foreach ( $friendslist as $friends) : ?>
                          <div class="div1">  
                            <ul>  
                                  <li>
                                      <img src="<?php echo $friends['img'];?>" class="friend-image"> 
                                    <a href="<?php echo "profile.php?id=".$friends['iduser'];?>"><?php echo $friends['firstname']." ".$friends['lastname'];?></a></li>
                              </ul>
                          </div>  
                        <?php endforeach;?>
