...
<html>
  <head>
    ...
    <title>wazifa | search results</title>
  ...
  <body class="skin-blue">
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu" id="somess">
            ...
            <li class="dropdown messages-menu">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?php $_SESSION['username'] ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
...
<!--php search result function callling from class user included -->
              ...
              <div class="box box-solid">
                <div class="box-body">
                  <div class="row">
                    ...
                    if(isset( $_GET['q'])&&isset($_GET['seach'])){
                    //$user_id=$_REQUEST['id'];
                     $fullname=$_GET['q'];
                    
                     $member=new member();
                     $output= $member->search($fullname);
      
                if(count($output)==0){
                echo '<p>no result matches your search </p>';
                  }
            
                 else{foreach ($output as $resault ) : ?>
                    
                  <div class="table-responsive"style="hieght:100px;">
                  <div class="1">
                         <ul>
                           <li><img src="<?php echo $resault['img']; ?>">
                          <a href="profile.php?id=<?php echo $resault['iduser'];?>"> <p class="p1"><?php echo $resault['firstname']." ".$resault['lastname'];?></p></li>
                           <hr>
                       </div>
                   ...
                   <div class="pull-left">
                    ...
                    <div style="">
                        <ul class="nav nav-pills nav-stacked">
                          ...
                          <li class="active"><a href="#"><i class="fa fa-inbox"></i>  results (<?php echo count($output);?>)</a></li>
                        </ul>
                          </div>
                        </div>
                   </div>
