     ...
     <header class="main-header">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-3">
              <a href="composemess.php" class="btn btn-primary btn-block margin-bottom">Compose</a>
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="newmessagses.php"><i class="fa fa-inbox"></i> Inbox </a></li>
                  </ul>
                </div><!-- /.box-body -->
              </div><!-- /. box -->
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                      ...
                      //$db=new database();
                      $member= new member();
                      $messages = $member->viewMessage($messageid);
                      foreach ($messages as $message) : ?>
                      <div>
             <ul>
             <li>
             
              <a href="<?php echo "profile.php?id=". $senderid;?>">
              <?php echo $sendername;?></p> </a>
